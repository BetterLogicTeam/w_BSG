export const financeAppContractAddress =
  "0x1A205A7bE00A6E41f1506Bff7e309caC2a43d4d9";
export const financeAppContract_Abi = [
  ...
  },
  {
    ...
    name: "BoosterCheck",
    outputs: [
      { internalType: "uint256", name: "reachTime", type: "uint256" },
  ...
  },
  {
    ...
    name: "FlushRecords",
    outputs: [
      { internalType: "uint256", name: "latetFlush", type: "uint256" },
      { internalType: "uint256", name: "totalFlush", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
